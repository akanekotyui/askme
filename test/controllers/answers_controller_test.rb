...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { code: @answer.code, en: @answer.en, jp: @answer.jp, zh: @answer.zh } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { code: @answer.code, en: @answer.en, jp: @answer.jp, zh: @answer.zh } }
